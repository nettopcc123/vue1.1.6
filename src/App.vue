...
import footer from '@/components/footer07';
...
　　},
    $route(to,from){
        if(to.path == '/' || to.path == '/member' || to.path == '/news'){ //用户中心
            this.ish80 = true;
        }else{
            this.ish80 = false;
        }
        ...
        let marr = ['/vip','/liberty','/coupon','/login','/register','/feedback','/message','/messageshow','/favorites','/disclaimer','/fans','/follow','/profile','/newlists1','/newlists2','/newlists3','/newlists4','/newlists5','/newlists6','/newlists7','/newsMore1'];
